...
import {
    axiosDownloadFile,
    configEnv, downloadImage, DownloadTask, getAllDownloadTask,
    getAllImageURL,
...
import {getList, getVolumeEpubMD5} from "./api";
import {crawlBookFileHash, crawlBookInfo, crawlBookList} from "./scripts";
...
const main = async () => {
    ...
    /// Step 6.
    const fileHash = loadJSON(process.env.FILEINFO_DIR);
